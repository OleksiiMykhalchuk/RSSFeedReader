...
public extension UIStoryboard {
  /**
   ...
   - parameter resource: An resource (R.storyboard.*.*) that uniquely identifies the view controller in the storyboard file. If the specified
   if which "${PODS_ROOT}/SwiftLint/swiftlint" >/dev/null; then
       ${PODS_ROOT}/SwiftLint/swiftlint
   else
       echo "warning: SwiftLint not installed, download from https://github.com/realm/SwiftLint"
   firesource does not exist in the storyboard file, this method raises an exception.
